...
#define PULSE_TIMEOUT 50000L	// 50ms
...
public:
	...
	*/
	long Distance( int _waitDelay=25 );
	float Distance_Float( int _waitDelay=25 );
	
	/**
	* Do count measurements and calculate the average. 
	...
	**/
	...
	float DistanceAvg_Float(int wait=DEFAULT_DELAY, int count=DEFAULT_PINGS);
...
private:
	...
	* <br>
	* Example: Obstacle 100cm away from SR04. Measure time is 100cm to
	...
	*/	
	...
	float MicrosecondsToCentimeter_Float(long duration);
