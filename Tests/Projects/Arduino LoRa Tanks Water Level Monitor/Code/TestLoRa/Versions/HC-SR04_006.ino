...
// Returns the raw time in µs before we receive an echo (this is the total round trip back and forth Time Of Flight), or 0 if the pule timed out
U32 MeasureEchoTime( U8 _pinTrigger, U8 _pinEcho ) {
  digitalWrite( _pinTrigger, HIGH );
  delayMicroseconds( 10 );
  digitalWrite( _pinTrigger, LOW );
  U32 duration_microSeconds = pulseIn( _pinEcho, HIGH, 1000000 );
