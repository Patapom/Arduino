...
// Define this to be the transmitter module and specify the transmitter address, undefine to be the receiver module
...
static const int  CLIENT_POLL_INTERVAL_MS = 1000; // Poll for a command every N ms
