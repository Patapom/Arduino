...
#define SAMPLING_RATE 32000L  // 32 kHz

// For best performance: don't use interrupts, don't use auto-ACK
//
//#define USE_INTERRUPTS        // Define this to use auto-acknowledge and "packet received" interrupts instead of constant polling via a timer
//#define USE_AUTO_ACK          // Define this to use the auto-ACK feature. !WARNING! It's very slow compared to manual monitoring of the packets!
